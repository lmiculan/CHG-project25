#!/usr/bin/env python2
# Workflow run script auto-generated by command: '/home/miculanl/bin/strelka-2.9.10/bin/configureStrelkaSomaticWorkflow.py --normalBam data/bamprocessing/realign/Control.sorted.realigned.bam --tumorBam data/bamprocessing/realign/Tumor.sorted.realigned.bam --referenceFasta data/annotations/human_g1k_v37.fasta --runDir results/svc_strelka2 --callRegions data/ogdata/Captured_Regions.bed.gz'
#
...
main(r"/run/media/miculanl/E87A653C7A6508A0/Users/Leonardo Miculan/Documents/UniTNNotes/A.A._2024-2025_1QCB/2nd_semester/Genomics/HumanGenom/CHG-project25/results/svc_strelka2/runWorkflow.py.config.pickle","StrelkaSomatic",StrelkaSomaticWorkflow)
