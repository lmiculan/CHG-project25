#!/usr/bin/env python2
# Workflow run script auto-generated by command: '/home/miculanl/bin/strelka-2.9.10/bin/configureStrelkaSomaticWorkflow.py --normalBam data/bamprocessing/recal2/Control.sorted.realigned.dedup.recal.bam --tumorBam data/bamprocessing/recal2/Tumor.sorted.realigned.dedup.recal.bam --referenceFasta data/annotations/human_g1k_v37.fasta --runDir results/svc2/svc_strelka2 --callRegions data/ogdata/Captured_Regions.bed.gz --exome'
#
...
sys.path.append(r'/home/miculanl/bin/strelka-2.9.10/lib/python')
...
main(r"/mnt/Windows/Users/Leonardo Miculan/Documents/UniTNNotes/A.A._2024-2025_1QCB/2nd_semester/Genomics/HumanGenom/CHG-project25/results/svc2/svc_strelka2/runWorkflow.py.config.pickle","StrelkaSomatic",StrelkaSomaticWorkflow)
